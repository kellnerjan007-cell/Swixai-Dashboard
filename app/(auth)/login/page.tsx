...
function LoginForm() {
  ...
  return (
    <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-8">
      ...
      {wasReset && (
        <div className="text-sm text-green-700 bg-green-50 px-4 py-2.5 rounded-xl border border-green-100 mb-4">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div>
          <div className="flex items-center justify-between mb-1.5">
            ...
            <Link href="/forgot-password" className="text-xs text-gray-500 hover:text-black transition">
              Passwort vergessen?
            </Link>
          </div>
          <input
